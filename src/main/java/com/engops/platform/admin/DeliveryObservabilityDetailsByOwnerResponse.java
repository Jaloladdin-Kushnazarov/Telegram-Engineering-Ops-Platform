...
/**
 * OwnerUserId bo'yicha filtrlangan delivery observability details endpoint'ining HTTP response DTO'si.
 *
...
public record DeliveryObservabilityDetailsByOwnerResponse(
